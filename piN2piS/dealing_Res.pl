...
my @pop=("AME","ASIA","EUR","IND","basic_set.snp");
...
open GENOME_STAT, ">Genome_check.stat";
...
open ERR, ">err.ck";
for my $p (@pop){
        open TMP, ">SNPGenie_res_dealing.tmp.$p";
...
open OUT, ">SNPGenie_res_dealing.res";
print OUT "Pop\t$id\n";
for my $p (@pop){
        print OUT "$p";
        for my $k (@keys){
...
__END__
file    sites   sites_coding    sites_noncoding pi      pi_coding       pi_noncoding    N_sites S_sites piN     piS     mean_dN_vs_ref  mean_dS_vs_ref  mean_gdiv_polymorphic   mean_N_gdiv     mean_S_gdiv     m
ean_gdiv        sites_polymorphic       mean_gdiv_coding_poly   sites_coding_poly       mean_gdiv_noncoding_poly        sites_noncoding_poly
/scratch/tmp/ywang1/01.duckweed/popgenomics/neutral_stat/split_chr//AME/ChrS19/ChrS19.vcf.AF_corrected.vcf      3727809 473454  3254355 0.000974306450639792    0.0006604793088573      0.00101996302946586     1
52140.280237587 49129.334599811 0.000353927851349201    0.000858030951549198    0.000309208666744975    0.000714132564777546    0.00660900161906613     0.26518144702167        0.26512080390582        0.0009616
14664760828     14345   0.259463153635798       1190    0.249027339338719       13155